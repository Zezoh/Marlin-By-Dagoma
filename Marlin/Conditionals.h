 ...
 */
 ...
 #define EXTRUDE_MINTEMP 170
...
#ifndef CONFIGURATION_STAGE // First-pass configuration guard

  #define CONFIGURATION_STAGE

#else // CONFIGURATION_STAGE
  ...
  #define HAS_FILRUNOUT2 (PIN_EXISTS(FILRUNOUT2))
