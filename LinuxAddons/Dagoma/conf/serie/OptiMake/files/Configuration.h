...
#define CUSTOM_MACHINE_NAME "Optimake"
...
#define TEMP_SENSOR_0 16
#define TEMP_SENSOR_1 0
#define TEMP_SENSOR_2 0
#define TEMP_SENSOR_3 0
#define TEMP_SENSOR_BED 11 // 11 pour le BED KENOVO is perfect 16 pour le bed 24 V 300x300
...
#define HEATER_0_MAXTEMP 300 //E3D-1.75mm
#define HEATER_1_MAXTEMP 300 //E3D-1.75mm
#define HEATER_2_MAXTEMP 300 //E3D-1.75mm
#define HEATER_3_MAXTEMP 300 //E3D-1.75mm
...
#define INVERT_Y_DIR true // false = pince sur brin gauche / true = pince sur brin DROIT
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 400, 98} // {80,80,4000,500}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {150, 150, 15, 50} // {300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {5000, 1000, 150, 10000} // {7500,3000,150,10000} A tester // {3000,3000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define PLA_PREHEAT_FAN_SPEED 130   // Insert Value between 0 and 255
